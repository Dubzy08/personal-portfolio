...
export const translations = {
    ...
    fr: {
        ...
        skillsDesc: "De la conception d'interfaces utilisateur intuitives avec React à l'architecture de relations de données complexes dans PSQL, j'utilise un ensemble diversifié de langages et d'outils modernes pour donner vie à des solutions numériques.",
        contactText: "Vous avez des questions ou souhaitez faire ma connaissance? Entrez en contact!",
